...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .brand { font-size: 16pt; font-weight: bold; color: #111827; }
        .inv-ref { text-align: right; }
        .inv-ref .inv-label { font-size: 8pt; text-transform: uppercase; letter-spacing: 0.1em; color: #6b7280; }
        .inv-ref .inv-num { font-size: 13pt; font-weight: bold; color: #111827; margin-top: 2px; }
        .inv-ref .status-paid {
        ...
        .party-left { padding-right: 20px; }
        .party-right { padding-left: 20px; }

        .party-label { font-size: 8pt; text-transform: uppercase; letter-spacing: 0.08em; color: #6b7280; font-weight: bold; margin-bottom: 5px; }
        .party-name { font-size: 11pt; font-weight: bold; color: #111827; margin-bottom: 4px; }
        .party-detail { font-size: 9pt; color: #4b5563; line-height: 1.6; }
        .vat-badge {
            display: inline-block; background: #f3f4f6; color: #4b5563;
            padding: 1px 5px; font-size: 7.5pt; font-weight: bold; border-radius: 2px; margin-top: 2px;
        }

        /* Dates */
        .dates-cells { border: none; margin-bottom: 28px; border-collapse: collapse; }
        .date-td { padding-right: 20px; vertical-align: top; }
        .date-label { font-size: 8pt; text-transform: uppercase; letter-spacing: 0.08em; color: #6b7280; font-weight: bold; }
        .date-value { font-size: 10pt; font-weight: bold; color: #111827; margin-top: 2px; }

        /* Items — Stripe-style: no alternating bg, minimal borders */
        table.items { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        table.items thead th {
            padding: 8px 0; font-size: 8pt; text-transform: uppercase;
            letter-spacing: 0.08em; color: #6b7280; font-weight: bold;
            border-bottom: 1px solid #e5e7eb; text-align: left;
        }
        table.items thead th.right { text-align: right; }
        table.items tbody td {
            padding: 10px 0; font-size: 9.5pt; border-bottom: 1px solid #f3f4f6; vertical-align: top; color: #111827;
        }
        table.items tbody td.right { text-align: right; }

        /* Totals */
        .totals-wrapper { border-top: 1px solid #e5e7eb; padding-top: 16px; margin-bottom: 28px; }
        ...
        .totals .grand-total td {
            ...
            border-top: 2px solid #111827; padding-top: 10px; margin-top: 6px;
        }
        ...
        /* Notes */
        .notes-section { background: #f9fafb; padding: 12px 14px; font-size: 9pt; color: #4b5563; margin-bottom: 24px; }
        .notes-label { font-weight: bold; color: #374151; font-size: 8pt; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 5px; }

        /* Footer */
        .footer { padding-top: 16px; border-top: 1px solid #e5e7eb; font-size: 8pt; color: #9ca3af; text-align: center; }
    </style>
</head>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td style="vertical-align:middle;">
                    @if ($company?->logoUrl())
                        <img src="{{ $company->logoUrl() }}" alt="{{ $company->name }}" style="max-height:40px; max-width:150px;">
                    @else
