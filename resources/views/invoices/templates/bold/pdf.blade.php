...
<body>
    ...
    <div class="page">
        ...
        {{-- Dates --}}
        <table class="dates-row" cellpadding="0" cellspacing="0" style="width:100%; margin-bottom:32px;">
            <tr>
        ...
        @if (in_array($invoice->document_type, ['credit_note', 'debit_note']))
            <div class="correction-reference" style="margin: 0 0 16px; padding: 8px; background: #f9f9f9; border-left: 3px solid #ccc;">
