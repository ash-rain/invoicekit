...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Header */
        .header { width: 100%; margin-bottom: 18px; border-collapse: collapse; border-bottom: 2px solid #1e40af; padding-bottom: 12px; }
        .brand { font-size: 16pt; font-weight: bold; color: #1e40af; }
        .invoice-number-block { text-align: right; }
        .invoice-number-block .inv-num { font-size: 11pt; font-weight: bold; color: #111827; }
        .invoice-number-block .inv-label { font-size: 7.5pt; color: #6b7280; text-transform: uppercase; letter-spacing: 0.08em; }
        .paid-chip {
        ...
        .party-label { font-size: 7pt; text-transform: uppercase; letter-spacing: 0.08em; color: #9ca3af; font-weight: bold; margin-bottom: 3px; }
        .party-name { font-size: 9.5pt; font-weight: bold; color: #111827; }
        .party-detail { font-size: 8.5pt; color: #4b5563; line-height: 1.5; }
        .vat-badge { display: inline-block; background: #f3f4f6; color: #4b5563; border-radius: 2px; padding: 0 5px; font-size: 7.5pt; font-weight: bold; }

        .date-item { margin-bottom: 7px; }
        .date-label { font-size: 7pt; text-transform: uppercase; letter-spacing: 0.08em; color: #9ca3af; font-weight: bold; }
        .date-value { font-size: 9pt; font-weight: bold; color: #111827; }

        /* Items — dense */
        table.items { width: 100%; border-collapse: collapse; margin-bottom: 12px; }
        table.items thead tr { background: #1e40af; color: #fff; }
        table.items thead th {
            padding: 5px 8px; font-size: 7.5pt; text-transform: uppercase;
            letter-spacing: 0.06em; text-align: left; font-weight: bold;
        }
        table.items thead th.right { text-align: right; }
        table.items tbody tr:nth-child(even) { background: #f8fafc; }
        table.items tbody td {
            padding: 5px 8px; font-size: 8.5pt; border-bottom: 1px solid #f1f5f9; vertical-align: top;
        }
        table.items tbody td.right { text-align: right; }

        /* Totals */
        .totals { width: 220px; margin-left: auto; margin-bottom: 14px; }
        .totals table { width: 100%; border-collapse: collapse; }
        .totals table td { padding: 3px 0; font-size: 8.5pt; color: #4b5563; }
        .totals table td.right { text-align: right; }
        .totals .grand-total td { font-size: 10pt; font-weight: bold; color: #1e40af; border-top: 2px solid #1e40af; padding-top: 5px; }

        /* VAT notice */
        .vat-notice { margin-bottom: 12px; padding: 7px 10px; border-radius: 3px; font-size: 8pt; line-height: 1.4; }
        ...
        /* Notes */
        .notes-section { background: #f8fafc; border: 1px solid #e5e7eb; padding: 8px 10px; font-size: 8pt; color: #4b5563; margin-bottom: 14px; }
        .notes-label { font-weight: bold; color: #374151; font-size: 7pt; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 3px; }

        /* Footer */
        .footer { padding-top: 10px; border-top: 1px solid #e5e7eb; font-size: 7pt; color: #9ca3af; text-align: center; }
    </style>
</head>
        ...
        <table class="header" cellpadding="0" cellspacing="0">
            <tr>
                <td style="vertical-align:middle;">
                    @if ($company?->logoUrl())
                        <img src="{{ $company->logoUrl() }}" alt="{{ $company->name }}" style="max-height:36px; max-width:140px;">
                    @else
