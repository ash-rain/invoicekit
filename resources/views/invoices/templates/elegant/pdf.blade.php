...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Header */
        .header { width: 100%; margin-bottom: 40px; border-collapse: collapse; }
        .brand { font-size: 19pt; font-weight: bold; color: #111827; letter-spacing: -0.3px; }
        ...
        .invoice-number { font-size: 16pt; font-weight: bold; color: #111827; margin-top: 3px; }

        /* Thin accent rule */
        .accent-rule { border: none; border-top: 1px solid #d1d5db; margin: 0 0 36px 0; }

        /* Paid status */
        .paid-tag {
            display: inline-block; color: #059669; font-size: 9pt;
        ...
        .party-left { padding-right: 28px; }
        .party-right { padding-left: 28px; border-left: 1px solid #e5e7eb; }

        .party-label {
            font-size: 7.5pt; text-transform: uppercase; letter-spacing: 0.12em;
            color: #9ca3af; font-weight: bold; margin-bottom: 10px;
        }
        .party-name { font-size: 12.5pt; font-weight: bold; color: #111827; margin-bottom: 6px; }
        .party-detail { font-size: 9pt; color: #6b7280; line-height: 1.7; }

        .vat-badge {
            display: inline-block; background: #f3f4f6; color: #6b7280;
            border-radius: 3px; padding: 1px 6px; font-size: 7.5pt; font-weight: bold; margin-top: 3px;
        }

        /* Dates — clean inline row */
        .dates-row { margin-bottom: 36px; border-collapse: collapse; }
        .date-item { padding-right: 32px; vertical-align: top; }
        .date-label {
            font-size: 7.5pt; text-transform: uppercase; letter-spacing: 0.1em;
            color: #9ca3af; font-weight: bold;
        }
        .date-value { font-size: 10.5pt; font-weight: bold; color: #111827; margin-top: 3px; }

        /* Items — refined minimal */
        table.items { width: 100%; border-collapse: collapse; margin-bottom: 24px; }
        table.items thead th {
            padding: 7px 10px; font-size: 7.5pt; text-transform: uppercase;
            letter-spacing: 0.1em; color: #9ca3af; font-weight: bold;
            border-bottom: 1px solid #e5e7eb; text-align: left;
        }
        table.items thead th.right { text-align: right; }
        table.items tbody td {
            padding: 10px 10px; font-size: 9.5pt; border-bottom: 1px solid #f3f4f6; vertical-align: top; color: #374151;
        }
        table.items tbody td.right { text-align: right; }

        /* Totals */
        .totals { width: 270px; margin-left: auto; margin-bottom: 28px; }
        .totals table { width: 100%; border-collapse: collapse; }
        .totals table td { padding: 6px 0; font-size: 9.5pt; color: #6b7280; }
        .totals table td.right { text-align: right; }
        .totals .subtotal-rule td { border-top: 1px solid #e5e7eb; }
        .totals .grand-total td {
            font-size: 12.5pt; font-weight: bold; color: #111827;
            border-top: 2px solid #d1d5db; padding-top: 10px; margin-top: 4px;
        }
        ...
        /* Notes */
        .notes-section { background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 4px; padding: 13px 15px; font-size: 9pt; color: #6b7280; margin-bottom: 24px; }
        .notes-label { font-weight: bold; color: #374151; font-size: 7.5pt; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 5px; }

        /* Footer */
        .footer { margin-top: 36px; padding-top: 14px; border-top: 1px solid #e5e7eb; font-size: 7.5pt; color: #9ca3af; text-align: center; }
    </style>
</head>
