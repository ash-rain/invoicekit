...
<body>
    ...
    <div class="container">
        ...
        <p>These Terms of Service ("Terms") govern your use of InvoiceKit (the "Service"). By creating an account you agree to these Terms.</p>

        <h2>1. Description of Service</h2>
        <p>InvoiceKit is a SaaS platform for invoicing and time tracking designed for EU-based freelancers. Features vary by subscription plan.</p>
        ...
        <p>InvoiceKit offers Free, Starter (€15/month), and Pro (€29/month) plans. Payments are processed by Stripe. Subscriptions renew automatically. You may cancel at any time; cancellation takes effect at the end of the billing period.</p>

        <h2>4. Acceptable Use</h2>
        <p>You may not use the Service for any unlawful purpose, including VAT fraud. You may not reverse-engineer, resell, or redistribute the Service.</p>

        <h2>5. Data and Privacy</h2>
        <p>We handle your data in accordance with our <a href="{{ url('/privacy') }}">Privacy Policy</a>. You own your business data; we process it only to provide the Service.</p>

        <h2>6. VAT Compliance Notice</h2>
        <p>InvoiceKit automates VAT calculations based on the rules you configure. You remain responsible for the accuracy of VAT information submitted to tax authorities. InvoiceKit is not a tax advisor.</p>

        <h2>7. Limitation of Liability</h2>
        <p>To the maximum extent permitted by law, InvoiceKit is not liable for indirect, incidental, or consequential damages arising from your use of the Service.</p>
