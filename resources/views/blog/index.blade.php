    ...
    @else
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            @foreach ($posts as $post)
                <article class="group flex flex-col rounded-2xl border border-gray-100 overflow-hidden hover:border-indigo-200 hover:shadow-md transition-all duration-200">
                    ...
                    @else
                        <div class="aspect-video overflow-hidden bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center">
                            <img src="{{ url('/images/og-thumb.png') }}" alt="InvoiceKit" class="h-12 w-12 object-contain opacity-40">
                        </div>
                    @endif
                    ...
                    <div class="flex flex-col flex-1 p-5">
                        ...
                        <h2 class="text-base font-semibold text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors">
